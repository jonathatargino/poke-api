...
<p>O projeto é um software que recebe dados de Pokemons da API <a href="https://pokeapi.co">PokeAPI</a> através do método fetch.</p>
<p>Esse projeto foi feito com o objetivo de conhecer o HTTP request e response e a integração de API's</p>

## 🎨 Layout

![layou1](https://github.com/jonathatargino/poke-api/blob/main/assets/poke-api-img-1.png)
